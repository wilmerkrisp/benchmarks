...
//--------------------------------------------------------------------------------
//
//                          experiment2  life.expert.algo.research.values
//                           wilmer 2019/05/04
//
//--------------------------------------------------------------------------------
...
/**
 * simple immutable class: String String
 *
 * - pattern new-call
 * - not for inheritance
 *
 ...
 * //pattern new-call
 * 	  var  o = Boy.of("Test");
 * 	  var o = Boy.<String, String>builder().item1("f").build();
 * var b=o.compute();
 * }*</pre>
 *
 *
...
@Slf4j
@Patterns /*pattern matching in vavr*/ public final class Boy
	implements Comparable<Boy>
	{
	 ...
	 * 	the item2
	 */
	@NonNull private final String item2;
	...
	pattern matching in vavr
	    ...
	    import static life.expert.algo.research.values.BoyPatterns.*;	*/
	@Unapply
	static Tuple2<String,String> Boy( Boy tuple )
		{
		return Tuple.of( tuple.getItem1() ,
		                 tuple.getItem2() );
